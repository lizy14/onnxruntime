...
void InferenceSession::ConstructorCommon(const SessionOptions& session_options,
  ...
  {
    concurrency::ThreadPoolOptions to;
    ...
    to.thread_pool_size = session_options_.intra_op_num_threads;
    to.thread_options.stack_size = session_options_.stack_size;
    to.allow_spinning = session_options_.thread_pool_allow_spinning;
    thread_pool_ =
  ...
  if(session_options_.execution_mode == ExecutionMode::ORT_PARALLEL){
    ...
    to.thread_pool_size = session_options_.inter_op_num_threads;
    to.thread_options.stack_size = session_options_.stack_size;
    to.allow_spinning = session_options_.thread_pool_allow_spinning;
